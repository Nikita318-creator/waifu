            ...
            WaifuSlideData(
                ...
                questions: [
                    WaifuQuestion(
                        ...
                        options: [
                            "CreateDreamWaifu.option.spetialArchetype1".localize(),
                            "CreateDreamWaifu.option.spetialArchetype2".localize(),
                            "CreateDreamWaifu.option.spetialArchetype3".localize(),
                            "CreateDreamWaifu.option.spetialArchetype4".localize(),
                            "CreateDreamWaifu.option.spetialArchetype5".localize(),
                        ],
                        allowMultipleSelection: false
                    ),
